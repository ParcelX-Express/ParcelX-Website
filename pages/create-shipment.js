...
export default function CreateShipment() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] font-sans text-[#333333]">
      {/* Professional FedEx Style Header */}
      <header className="bg-[#4D148C] text-white py-3 px-4 md:px-12 flex justify-between items-center sticky top-0 z-50">
      ...
      <main className="max-w-4xl mx-auto p-0 md:p-8 bg-white min-h-screen md:min-h-0 md:mt-4 shadow-sm">
        <div className="p-4 md:p-0">
          ...
          <div className="bg-white p-6 border-l-4 border-[#FF6200] shadow-sm mb-6">
            ...
            <div className="flex gap-3">
              <button className="bg-[#FF6200] text-white px-6 py-2.5 font-bold uppercase text-xs hover:bg-[#e55800] transition-colors">
                CREATE ACCOUNT
              </button>
              <button className="border border-[#4D148C] text-[#4D148C] px-6 py-2.5 font-bold uppercase text-xs hover:bg-gray-50 transition-colors">
                LOG IN
              </button>
            </div>
          </div>
        ...
        <div className="divide-y divide-gray-200 border-t border-b border-gray-200">
          ...
          <div className="bg-white">
            ...
            >
              <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${activeSection === 'Ship from' ? 'border-[#4D148C] text-[#4D148C]' : 'border-gray-300 text-gray-300'}`}>
                ...
                {activeSection === 'Ship from' && <div className="w-2 h-2 rounded-full bg-[#4D148C]" />}
              </div>
              <span className={`font-bold ${activeSection === 'Ship from' ? 'text-[#4D148C]' : 'text-gray-500'}`}>Ship from</span>
            </button>
            ...
            {activeSection === 'Ship from' && (
              <div className="px-12 pb-8 pt-2 space-y-8">
                ...
                <div className="pt-4">
                  ...
                  <div className="mt-10">
                    <button className="bg-[#FF6200] text-white px-12 py-3.5 font-bold uppercase text-sm hover:bg-[#e55800] transition-colors shadow-md">
                      NEXT
                    </button>
                  </div>
                </div>
          ...
          {['Deliver to', 'Package details', 'Service', 'Service options', 'Pickup/drop-off', 'Notifications'].map((section) => (
            <div key={section} className="bg-white">
              <button className="w-full flex items-center gap-3 p-4 text-left">
                <div className="w-5 h-5 rounded-full border border-gray-300 flex items-center justify-center text-gray-300">
        ...
        <div className="p-8 bg-white mt-4 border-t border-gray-100">
          ...
          <div className="flex gap-4 mb-6 opacity-80 grayscale">
            {/* Mock payment icons */}
            <div className="w-12 h-8 bg-blue-800 rounded flex items-center justify-center text-white text-[8px] font-bold italic">VISA</div>
            <div className="w-12 h-8 bg-red-600 rounded flex items-center justify-center text-white text-[8px] font-bold italic">MC</div>
            <div className="w-12 h-8 bg-blue-400 rounded flex items-center justify-center text-white text-[8px] font-bold italic">AMEX</div>
          </div>
          <p className="text-xs text-gray-600">
            If you're looking to 'Bill to an Account', please <Link href="#" className="text-[#007AB7] underline">create an account</Link> or <Link href="#" className="text-[#007AB7] underline">log in</Link>
          </p>
          <div className="mt-8 border-t border-gray-100 pt-6">
            <button className="w-full py-3 text-sm font-bold text-[#007AB7] uppercase border border-gray-200">
