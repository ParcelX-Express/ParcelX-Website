  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] font-sans">
      ...
      <main className="max-w-4xl mx-auto p-8 bg-white mt-8 shadow-sm rounded">
        <h1 className="text-3xl font-light mb-6">Packing & Shipping Supplies</h1>
        <p className="text-gray-600 mb-8">This page is currently under construction. Please check back later for more updates.</p>
