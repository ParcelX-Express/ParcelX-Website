...
"[project]/pages/api/send-welcome-email.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            <td style="padding: 30px 40px; background-color: #f7fafc; border-top: 1px solid #e2e8f0;">
              ...
              <table role="presentation" style="width: 100%;">
                ...
                <tr>
                  ...
                  <td style="color: #1e3a5f; font-size: 14px; padding: 5px 0; text-align: right; font-weight: 600;">${new Date().toLocaleDateString('en-US', {
        year: 'numeric',
        month: 'long',
        day: 'numeric'
    })}</td>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4a33342._.js.map